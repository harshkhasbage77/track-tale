...
export const TextResourcesPanel = observer(() => {
  ...
  const CANVAS_WIDTH = store.canvasWidth;
  const CANVAS_HEIGHT = store.canvasHeight;
  ...
  const TEXT_RESOURCES = [
    ...
    },
    {
      ...
      fontSize: 24,
      fontWeight: 800,
      hasControls: true, // ABHI K LIYE TRUE KAR RAHA HU ... BUT ACTUALLY FALSE HONA CHAHIYE
